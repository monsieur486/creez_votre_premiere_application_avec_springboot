...
class FloodEndPointServiceTest {
    ...
    FloodEndPointService classToTest = new FloodEndPointService(jsonFilePersonService, jsonFileFirestationService, jsonFileMedicalRecordService);

    @Test
    void getPersonListByStationNumberList() {
        ...
        assertNotNull(classToTest.getPersonListByStationNumberList("1,2"));
